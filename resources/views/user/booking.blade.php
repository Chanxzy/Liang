...
<body>
    ...
    <div class="banner-image-booking w-100 vh-100 d-flex justify-content-center align-items-center" data-aos="fade-down">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8" data-aos="fade-right">
                ...
                <div>
                    <a href="/detailkamar/4" class="btn rounded-pill text-white" style="background-color: #EF008C;">Book Now</a>
                </div>
            </div>
            <div class="col-md-4" data-aos="fade-left">
                <img src="img/foto/pool/Villa Liang Ubud - 11.jpg" alt="Image" class="img-fluid">
            </div>
        </div>
    </div>
</br>
